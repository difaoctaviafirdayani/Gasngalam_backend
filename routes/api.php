...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Notifications — PENTING: route statis harus SEBELUM route dengan parameter {id}
    Route::get('/notifications',              [NotificationController::class, 'index']);
    Route::get('/notifications/unread-count', [NotificationController::class, 'unreadCount']);
    Route::patch('/notifications/read-all',   [NotificationController::class, 'markAllRead']); // ← pindah ke atas
    Route::patch('/notifications/{id}/read',  [NotificationController::class, 'markRead']);    // ← {id} belakang
